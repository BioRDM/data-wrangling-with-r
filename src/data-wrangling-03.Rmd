...
```
Now we can inspect which sites are missing from the two files. Lets use anti_join function from dplyr package
...
1. Remove the misspelled sites from renamed_site_data
